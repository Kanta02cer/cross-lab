        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-8">
          {communities.map((community, index) => (
            ...
            >
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center text-cyan-400 font-medium text-sm hover:text-cyan-300 active:text-cyan-200 transition-colors group/link whitespace-nowrap min-h-[44px] px-4 py-2 touch-manipulation"
              >
                参加する
